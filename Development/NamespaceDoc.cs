...
namespace Gurux.Terminal
{
    ...
    /// <p>Open Source GXTerminal media component, made by Gurux Ltd, is a part of GXMedias set of media components, which programming interfaces help you implement communication using modem communication. </p>
    /// <p>Our media components also support the following connection types: network and Serial Port.</p>
    ...
    /// <ul>
    /// <li><see cref="Gurux.Terminal.GXTerminal.PhoneNumber"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.PortName"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.BaudRate"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.DataBits"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.Parity"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.StopBits"/></li>
    /// </ul>
    /// <p>It is also good to listen following events:</p>
    /// <ul>
    /// <li><see cref="Gurux.Terminal.GXTerminal.OnError"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.OnReceived"/></li>
    /// <li><see cref="Gurux.Terminal.GXTerminal.OnMediaStateChange"/></li>
    /// </ul>
    /// <example>
    /// <code>
